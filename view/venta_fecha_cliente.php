                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Consulta Ventas por Cliente &nbsp; 
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Consulta Ventas por Cliente</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
...
<?php
    require 'footer.php';
?> 
<script type="text/javascript" src="script/ventasfechacliente.js"></script>    