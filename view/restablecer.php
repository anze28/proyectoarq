...
<div class="auth-page">
    <div class="container-fluid p-0">
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Restablecer tu Contraseña</h5>
                                    <p class="text-muted mt-2">Utiliza el formulario para ingresar una nueva contraseña.</p>
                                </div>
                                <form method="post" id="frmRestablecer" name="frmRestablecer">
                                    <div class="mb-3">
                                        <label class="form-label">Contraseña</label>
                                        <input type="hidden" id="token" name="token" value="<?php echo $token ?>">
                                        <input type="hidden" id="idusuario" name="idusuario" value="<?php echo $idusuario ?>">
                                        <input type="password" class="form-control" id="clave" name="clave" placeholder="Recupera tu contraseña">
                                        <span class="text-danger"></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Confirmar Contraseña</label>
                                        <input type="password" class="form-control" id="clave1" name="clave1" placeholder="Confirmación de contraseña">
                                        <span class="text-danger"></span>
                                    </div>
                                    <div class="mb-3 mt-4">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type='submit' name='submit' id='submit' value='Submit'>Cambiar Contraseña</button>
                                    </div>
                                </form>
                            </div>
        ...
        <script type="text/javascript" src="script/restablecer.js"></script>
</body>
