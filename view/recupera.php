...
<div class="auth-page">
    <div class="container-fluid p-0">
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Utiliza el formulario para comprobar tu registro por email.</p>
                                </div>
                                <form method="post" id="frmRestablecer" name="frmRestablecer">
                                    ...
                                    <div class="mb-3 mt-4">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type='submit' name='submit' value='Submit'>Revisar</button>
                                    </div>
                                </form>
                            </div>
        ...
        <script type="text/javascript" src="script/recupera.js"></script>
</body>
